...
public class Eliminar extends javax.swing.JFrame {
    ...
    private static Eliminar instancia;
    ...
    private void btn_eliminaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminaActionPerformed
        ...
        if (respuesta == JOptionPane.YES_OPTION) {
            ...
            if (RegistroEncomiendas.eliminar(Integer.parseInt(txt_id_elimina.getText())) == true) {
                JOptionPane.showMessageDialog(null, "ID numero " + Integer.parseInt(txt_id_elimina.getText()) + " fue removido con exito");
            } 
            else {
                JOptionPane.showMessageDialog(null, "ID numero " + Integer.parseInt(txt_id_elimina.getText()) + " no pertenece a la base de datos.");
